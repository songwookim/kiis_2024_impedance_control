...
#include "custom_interfaces/srv/detail/set_positions__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::srv::SetPositions_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::SetPositions_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::SetPositions_Request *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SetPositions_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::srv::SetPositions_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::SetPositions_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::SetPositions_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SetPositions_Response__handle;
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_SetPositions__handle;
}
