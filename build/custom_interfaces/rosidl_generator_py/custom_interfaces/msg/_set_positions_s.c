...
bool custom_interfaces__msg__set_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._set_positions.SetPositions", full_classname_dest, 49) == 0);
  }
  custom_interfaces__msg__SetPositions * ros_message = _ros_message;
  {  // ids
...
{
  /* NOTE(esteve): Call constructor of SetPositions */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._set_positions");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetPositions");
