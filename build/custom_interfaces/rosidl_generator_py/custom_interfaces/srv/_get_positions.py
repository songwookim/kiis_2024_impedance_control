...
class Metaclass_GetPositions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.GetPositions')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _get_positions
...
class GetPositions(metaclass=Metaclass_GetPositions):
    from custom_interfaces.srv._get_positions import GetPositions_Request as Request
    from custom_interfaces.srv._get_positions import GetPositions_Response as Response
