...
class Metaclass_SetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.SetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _set_position
...
class SetPosition(metaclass=Metaclass_SetPosition):
    from custom_interfaces.srv._set_position import SetPosition_Request as Request
    from custom_interfaces.srv._set_position import SetPosition_Response as Response
